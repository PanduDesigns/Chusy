...
js/
  ...
  data/
    ...
    tasks.js                   CRUD de tareas (proyecto y personales) + operaciones en lote para la selección múltiple de Lista (mover, cambiar de proyecto, mover a mis tareas, asignar, fechas, completar, combinar duplicadas, borrar)
  ...
  components/
    ...
    bulk-toolbar.js                        Barra flotante de acciones masivas sobre la selección (mover, cambiar de proyecto, mover a mis tareas, asignar, fechas, completar, combinar duplicadas, convertir en hitos...)
    sections-modal.js                       Crear/renombrar/eliminar las secciones de un proyecto (columnas del Tablero, agrupaciones de la Lista)
    celebration.js                          Animación de confeti al completar tareas (una sola, y una versión más vistosa al completar varias de golpe)
